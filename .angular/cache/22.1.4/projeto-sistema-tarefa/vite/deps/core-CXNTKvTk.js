...
import { Qn as Subject, Zn as BehaviorSubject, rr as Observable, ur as Subscription, vn as map } from "./esm5-BupzNxh_.js";
...
var TransferState = class {
	constructor() {
		...
		_defineProperty(this, "onSerializeCallbacks", {});
	}
...
function setDirectiveInput(tNode, tView, lView, target, publicName, value) {
	var _tNode$directiveToInd, _tNode$hostDirectiveI4;
	let hostIndex = null;
	...
	if (hostDirectivesStart !== null && hostDirectivesEnd !== null && ((_tNode$hostDirectiveI4 = tNode.hostDirectiveInputs) === null || _tNode$hostDirectiveI4 === void 0 ? void 0 : _tNode$hostDirectiveI4.hasOwnProperty(publicName))) {
...
function acceptNode(node) {
	...
	return ((_node$textContent5 = node.textContent) === null || _node$textContent5 === void 0 ? void 0 : _node$textContent5.trimStart().startsWith("ngh=")) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT;
}
...
function listenToDirectiveOutput(tNode, lView, target, eventName, listenerFn) {
	var _tNode$directiveToInd2, _tNode$hostDirectiveO;
	let hostIndex = null;
	let hostDirectivesStart = null;
	let hostDirectivesEnd = null;
	let hasOutput = false;
	...
	if (hostDirectivesStart !== null && hostDirectivesEnd !== null && ((_tNode$hostDirectiveO = tNode.hostDirectiveOutputs) === null || _tNode$hostDirectiveO === void 0 ? void 0 : _tNode$hostDirectiveO.hasOwnProperty(eventName))) {
...
function setupHostDirectiveInputsOrOutputs(mode, tNode, config, directiveIndex) {
	...
	for (const initialName in aliasMap) if (aliasMap.hasOwnProperty(initialName)) {
		...
		let bindings;
		if (mode === 0) {
			var _tNode$hostDirectiveI5;
			bindings = (_tNode$hostDirectiveI5 = tNode.hostDirectiveInputs) !== null && _tNode$hostDirectiveI5 !== void 0 ? _tNode$hostDirectiveI5 : tNode.hostDirectiveInputs = {};
		} else {
			var _tNode$hostDirectiveO2;
			bindings = (_tNode$hostDirectiveO2 = tNode.hostDirectiveOutputs) !== null && _tNode$hostDirectiveO2 !== void 0 ? _tNode$hostDirectiveO2 : tNode.hostDirectiveOutputs = {};
		}
...
function setClassMetadata(type, decorators, ctorParameters, propDecorators) {
	return noSideEffects(() => {
		...
		if (propDecorators !== null) if (clazz.hasOwnProperty("propDecorators") && clazz.propDecorators !== void 0) clazz.propDecorators = _objectSpread2(_objectSpread2({}, clazz.propDecorators), propDecorators);
...
function componentNeedsResolution(component) {
	...
	return !!(component.templateUrl && !component.hasOwnProperty("template") || ((_component$styleUrls2 = component.styleUrls) === null || _component$styleUrls2 === void 0 ? void 0 : _component$styleUrls2.length) || component.styleUrl);
}
...
function ɵɵforeignComponent(index, foreignComponentIndex, props) {
	...
	const [nodes, dispose] = foreignComponent[RENDER](props, context !== null && context !== void 0 ? context : void 0);
...
function listenerInternal(tView, lView, renderer, tNode, eventName, listenerFn, eventTargetResolver) {
	...
	if (processOutputs) {
		var _tNode$outputs2, _tNode$hostDirectiveO3;
		const outputConfig = (_tNode$outputs2 = tNode.outputs) === null || _tNode$outputs2 === void 0 ? void 0 : _tNode$outputs2[eventName];
		const hostDirectiveOutputConfig = (_tNode$hostDirectiveO3 = tNode.hostDirectiveOutputs) === null || _tNode$hostDirectiveO3 === void 0 ? void 0 : _tNode$hostDirectiveO3[eventName];
...
function _declareExperimentalWebMcpTool() {
	_declareExperimentalWebMcpTool = _asyncToGenerator(function* (tool, injector) {
		...
		const wrappedTool = _objectSpread2(_objectSpread2({}, tool), {}, { execute: (args, client) => runInInjectionContext(currentInjector, () => tool.execute(args, _objectSpread2(_objectSpread2({}, client), {}, { signal: abortCtrl.signal }))) });
...
//#endregion
export { isDevMode as $, ɵɵdeferWhen as $a, assertNotInReactiveContext as $c, ɵgetUnknownElementStrictMode as $i, Output as $n, ɵɵpipeBind2 as $o, flushModuleScopingQueueAsMuchAsPossible as $r, ɵɵtextInterpolateV as $s, AfterRenderManager as $t, contentChild as A, ɵɵdefer as Aa, NG_DIR_DEF as Ac, provideZonelessChangeDetectionInternal as Ai, ɵɵenableBindings as Al, HydrationStatus as An, ɵɵi18nApply as Ao, _sanitizeUrl as Ar, ɵɵsanitizeScript as As, ɵɵngDeclareInjector as At, destroyPlatform as B, ɵɵdeferOnHover as Ba, PROVIDED_ZONELESS as Bc, resolveComponentResources as Bi, SIGNAL as Bl, LOCALE_ID as Bn, ɵɵinterpolate3 as Bo, bypassSanitizationTrustUrl as Br, ɵɵsyntheticHostProperty as Bs, computed as Bt, ViewChildren as C, ɵɵconditionalBranchCreate as Ca, IMAGE_CONFIG_DEFAULTS as Cc, outputBinding as Ci, store as Cl, DeferBlockState as Cn, ɵɵforeignContent as Co, TracingService as Cr, ɵɵrepeaterTrackByIndex as Cs, ɵassertType as Ct, assertPlatform as D, ɵɵcontrol as Da, InjectionToken as Dc, provideIdleServiceWith as Di, ɵɵdefineInjectable as Dl, Host as Dn, ɵɵgetInheritedFactory as Do, ViewEncapsulation$1 as Dr, ɵɵresolveWindow as Ds, ɵɵngDeclareDirective as Dt, annotateForHydration as E, ɵɵcontentQuerySignal as Ea, INTERNAL_APPLICATION_ERROR_HANDLER as Ec, provideAppInitializer as Ei, ɵunwrapWritableSignal as El, ElementRef as En, ɵɵgetCurrentView as Eo, ViewContainerRef as Er, ɵɵresolveDocument as Es, ɵɵngDeclareComponent as Et, createPlatformFactory as F, ɵɵdeferHydrateOnImmediate as Fa, NG_PROV_DEF as Fc, renderDeferBlockState as Fi, ɵɵnamespaceSVG as Fl, Injectable as Fn, ɵɵi18nStart as Fo, asNativeElements as Fr, ɵɵsetNgModuleScope as Fs, OutputEmitterRef as Ft, getModuleFactory as G, ɵɵdeferOnViewport as Ga, SecurityContext as Gc, setDocument as Gi, NO_CHANGE as Gn, ɵɵinterpolate8 as Go, compileNgModuleDefs as Gr, ɵɵtextInterpolate1 as Gs, resource as Gt, enableProdMode as H, ɵɵdeferOnImmediate as Ha, PendingTasksInternal as Hc, setAllowDuplicateNgModuleIdsForTest as Hi, MAX_ANIMATION_TIMEOUT as Hn, ɵɵinterpolate5 as Ho, compileComponent as Hr, ɵɵtemplateRefExtractor as Hs, getOutputDestroyRef as Ht, debounced as I, ɵɵdeferHydrateOnInteraction as Ia, NgZone as Ic, resetCompiledComponents as Ii, ɵɵresetView as Il, Input as In, ɵɵinjectAttribute as Io, bypassSanitizationTrustHtml as Ir, ɵɵstoreLet as Is, ResourceDependencyError as It, injectAsync as J, ɵɵdeferPrefetchOnImmediate as Ja, Version as Jc, transitiveScopesFor as Ji, NgModuleFactory as Jn, ɵɵlistener as Jo, createNgModule as Jr, ɵɵtextInterpolate4 as Js, ANIMATIONS_DISABLED as Jt, getNgModuleById as K, ɵɵdeferPrefetchOnHover as Ka, TransferState as Kc, setLocaleId as Ki, NO_ERRORS_SCHEMA as Kn, ɵɵinterpolateV as Ko, compilePipe as Kr, ɵɵtextInterpolate2 as Ks, setInParamsFunction as Kt, declareExperimentalWebMcpTool as L, ɵɵdeferHydrateOnTimer as La, NoopNgZone as Lc, resetIncrementalHydrationEnabledWarnedForTests as Li, ɵɵrestoreView as Ll, JSACTION_BLOCK_ELEMENT_MAP as Ln, ɵɵinterpolate as Lo, bypassSanitizationTrustResourceUrl as Lr, ɵɵstyleMap as Ls, ResourceImpl as Lt, createComponent as M, ɵɵdeferHydrateNever as Ma, NG_INJ_DEF as Mc, readHydrationInfo as Mi, ɵɵinvalidFactoryDep as Ml, IS_HYDRATION_DOM_REUSE_ENABLED as Mn, ɵɵi18nEnd as Mo, afterNextRender as Mr, ɵɵsanitizeUrl as Ms, ɵɵngDeclarePipe as Mt, createOrReusePlatformInjector as N, ɵɵdeferHydrateOnHover as Na, NG_MOD_DEF as Nc, registerLocaleData as Ni, ɵɵnamespaceHTML as Nl, IS_INCREMENTAL_HYDRATION_ENABLED as Nn, ɵɵi18nExp as No, allLeavingAnimations as Nr, ɵɵsanitizeUrlOrResourceUrl as Ns, ɵɵngDeclareService as Nt, booleanAttribute as O, ɵɵcontrolCreate as Oa, Injector as Oc, provideNgReflectAttributes as Oi, ɵɵdefineInjector as Ol, HostBinding as On, ɵɵgetReplaceMetadataURL as Oo, ViewRef$1 as Or, ɵɵsanitizeHtml as Os, ɵɵngDeclareFactory as Ot, createPlatform as P, ɵɵdeferHydrateOnIdle as Pa, NG_PIPE_DEF as Pc, registerNgModuleType as Pi, ɵɵnamespaceMathML as Pl, Inject as Pn, ɵɵi18nPostprocess as Po, allowSanitizationBypassAndThrow as Pr, ɵɵsetComponentScope as Ps, CACHE_ACTIVE as Pt, internalProvideZoneChangeDetection as Q, ɵɵdeferPrefetchWhen as Qa, assertInInjectionContext as Qc, unwrapSafeValue as Qi, Optional as Qn, ɵɵpipeBind1 as Qo, findLocaleData as Qr, ɵɵtextInterpolate8 as Qs, AcxViewEncapsulation as Qt, defaultIterableDiffers as R, ɵɵdeferHydrateOnViewport as Ra, PLATFORM_ID as Rc, resetIncrementalHydrationRuntimeForTests as Ri, setAlternateWeakRefImpl as Rl, JSACTION_EVENT_CONTRACT as Rn, ɵɵinterpolate1 as Ro, bypassSanitizationTrustScript as Rr, ɵɵstyleProp as Rs, ResourceParamsStatus as Rt, ViewChild as S, ɵɵconditional as Sa, IMAGE_CONFIG as Sc, noSideEffects as Si, signal as Sl, DeferBlockBehavior as Sn, ɵɵforeignComponent as So, TracingAction as Sr, ɵɵrepeaterTrackByIdentity as Ss, ɵINPUT_SIGNAL_BRAND_WRITE_TYPE as St, afterRenderEffect as T, ɵɵcontentQuery as Ta, INJECTOR_SCOPE as Tc, performanceMarkFeature as Ti, truncateMiddle as Tl, EVENT_REPLAY_QUEUE as Tn, ɵɵgetComponentDepsFactory as To, USE_PENDING_TASKS as Tr, ɵɵresolveBody as Ts, ɵɵngDeclareClassMetadataAsync as Tt, enableProfiling as U, ɵɵdeferOnInteraction as Ua, R3Injector as Uc, setClassMetadata as Ui, MissingTranslationStrategy as Un, ɵɵinterpolate6 as Uo, compileDirective as Ur, ɵɵtext as Us, isInParamsFunction as Ut, disableProfiling as V, ɵɵdeferOnIdle as Va, PendingTasks as Vc, restoreComponentResolutionQueue as Vi, LocaleDataIndex as Vn, ɵɵinterpolate4 as Vo, clearResolutionOfComponentResourcesQueue as Vr, ɵɵtemplate as Vs, encapsulateResourceError as Vt, getCurrentClosestComponentInstance as W, ɵɵdeferOnTimer as Wa, RuntimeError as Wc, setClassMetadataAsync as Wi, NOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR as Wn, ɵɵinterpolate7 as Wo, compileNgModule as Wr, ɵɵtextInterpolate as Ws, linkedSignal as Wt, input as X, ɵɵdeferPrefetchOnTimer as Xa, ZONELESS_ENABLED as Xc, twoWayBinding as Xi, NgModuleRef as Xn, ɵɵnextContext as Xo, devModeEqual as Xr, ɵɵtextInterpolate6 as Xs, APP_INITIALIZER as Xt, injectChangeDetectorRef as Y, ɵɵdeferPrefetchOnInteraction as Ya, XSS_SECURITY_URL as Yc, triggerResourceLoading as Yi, NgModuleFactory$1 as Yn, ɵɵloadQuery as Yo, depsTracker as Yr, ɵɵtextInterpolate5 as Ys, APP_BOOTSTRAP_LISTENER as Yt, internalCreateApplication as Z, ɵɵdeferPrefetchOnViewport as Za, _global as Zc, unregisterAllLocaleData as Zi, NgModuleRef$1 as Zn, ɵɵpipe as Zo, enableProfiling$1 as Zr, ɵɵtextInterpolate7 as Zs, AcxChangeDetectionStrategy as Zt, PlatformRef as _, ɵɵattachSourceLocations as _a, ENVIRONMENT_INITIALIZER as _c, isNgModule as _i, provideBrowserGlobalErrorListeners as _l, DEFER_BLOCK_DEPENDENCY_INTERCEPTOR as _n, ɵɵelementContainerEnd as _o, TRANSLATIONS_FORMAT as _r, ɵɵqueryRefresh as _s, viewChildren as _t, ContentChildren as a, ɵɵExternalStylesFeature as aa, ɵɵvalidateAttribute as ac, getDeferBlocks as ai, getComponentDef as al, ChangeDetectionStrategy as an, ɵɵdirectiveInject as ao, RendererFactory2 as ar, ɵɵproperty as as, output as at, REQUEST_CONTEXT as b, ɵɵclassProp as ba, ErrorHandler as bc, isViewDirty as bi, runInInjectionContext as bl, DebugEventListener as bn, ɵɵelementStart as bo, TestabilityRegistry as br, ɵɵrepeater as bs, withI18nSupport as bt, EmbeddedViewRef as c, ɵɵNgOnChangesFeature as ca, _objectWithoutProperties as cc, getHostElement as ci, inject as cl, Component as cn, ɵɵdomElementContainerEnd as co, SSR_CONTENT_INTEGRITY_MARKER as cr, ɵɵpureFunction2 as cs, provideExperimentalWebMcpTools as ct, HOST_TAG_NAME as d, ɵɵanimateEnter as da, APP_ID as dc, getLocalePluralCase as di, isSignal as dl, ComponentRef$1 as dn, ɵɵdomElementStart as do, Service as dr, ɵɵpureFunction5 as ds, provideZoneChangeDetection as dt, ɵgetUnknownPropertyStrictMode as ea, ɵɵtrustConstantHtml as ec, generateStandaloneInDeclarationsError as ei, convertToBitFlags as el, ApplicationInitStatus as en, ɵɵdefineComponent as eo, Pipe as er, ɵɵpipeBind3 as es, maybeUnwrapDefaultExport as et, HostAttributeToken as f, ɵɵanimateEnterListener as fa, CONTAINER_HEADER_OFFSET as fc, getSanitizationBypassType as fi, isStandalone as fl, Console as fn, ɵɵdomListener as fo, SimpleChange as fr, ɵɵpureFunction6 as fs, reflectComponentType as ft, PROVIDED_NG_ZONE as g, ɵɵarrowFunction as ga, DestroyRef as gc, isComponentDefPendingResolution as gi, promiseWithResolvers as gl, DEFER_BLOCK_CONFIG as gn, ɵɵelementContainer as go, TRANSLATIONS as gr, ɵɵqueryAdvance as gs, viewChild as gt, PERFORMANCE_MARK_PREFIX as h, ɵɵariaProperty as ha, DOCUMENT$1 as hc, inputBinding as hi, makeStateKey as hl, DEFAULT_LOCALE_ID as hn, ɵɵelement as ho, TESTABILITY_GETTER as hr, ɵɵpureFunctionV as hs, stopMeasuring as ht, ContentChild as i, ɵɵControlFeature as ia, ɵɵtwoWayProperty as ic, getDebugNode as ii, forwardRef as il, CUSTOM_ELEMENTS_SCHEMA as in, ɵɵdefineService as io, Renderer2 as ir, ɵɵprojectionDef as is, onIdle as it, contentChildren as j, ɵɵdeferEnableTimerScheduling as ja, NG_ELEMENT_ID as jc, publishNonCoreGlobalUtil as ji, ɵɵinject as jl, IS_ENABLED_BLOCKING_INITIAL_NAVIGATION as jn, ɵɵi18nAttributes as jo, afterEveryRender as jr, ɵɵsanitizeStyle as js, ɵɵngDeclareNgModule as jt, compileNgModuleFactory as k, ɵɵdeclareLet as ka, NG_COMP_DEF as kc, provideZonelessChangeDetection as ki, ɵɵdisableBindings as kl, HostListener as kn, ɵɵi18n as ko, _sanitizeHtml as kr, ɵɵsanitizeResourceUrl as ks, ɵɵngDeclareInjectable as kt, FactoryTarget as l, ɵɵProvidersFeature as la, _asyncToGenerator as lc, getLContext as li, isEnvironmentProviders as ll, ComponentFactory as ln, ɵɵdomElementContainerStart as lo, Sanitizer as lr, ɵɵpureFunction3 as ls, providePlatformInitializer as lt, KeyValueDiffers as m, ɵɵanimateLeaveListener as ma, ChangeDetectionScheduler as mc, inferTagNameFromDefinition as mi, makeEnvironmentProviders as ml, DEFAULT_CURRENCY_CODE as mn, ɵɵdomTemplate as mo, TESTABILITY as mr, ɵɵpureFunction8 as ms, startMeasuring as mt, CLIENT_RENDER_MODE_FLAG as n, ɵsetUnknownElementStrictMode as na, ɵɵtwoWayBindingSet as nc, getClosestComponentName as ni, effect as nl, Attribute as nn, ɵɵdefineNgModule as no, QueryList as nr, ɵɵpipeBindV as ns, model as nt, DefaultIterableDiffer as o, ɵɵHostDirectivesFeature as oa, ɵɵviewQuery as oc, getDirectives as oi, getInjectableDef as ol, Compiler as on, ɵɵdomElement as oo, RendererStyleFlags2 as or, ɵɵpureFunction0 as os, platformCore as ot, IterableDiffers as p, ɵɵanimateLeave as pa, CSP_NONCE as pc, getTransferState as pi, isWritableSignal as pl, ControlFlowBlockType as pn, ɵɵdomProperty as po, SkipSelf as pr, ɵɵpureFunction7 as ps, resourceFromSnapshots as pt, getPlatform as q, ɵɵdeferPrefetchOnIdle as qa, VERSION as qc, setTestabilityGetter as qi, NgModule as qn, ɵɵinvalidFactory as qo, createEnvironmentInjector as qr, ɵɵtextInterpolate3 as qs, untracked as qt, ChangeDetectorRef as r, ɵsetUnknownPropertyStrictMode as ra, ɵɵtwoWayListener as rc, getComponentInstanceDeepLinkId as ri, formatRuntimeError as rl, COMPILER_OPTIONS as rn, ɵɵdefinePipe as ro, ReflectionCapabilities as rr, ɵɵprojection as rs, numberAttribute as rt, ENABLE_ROOT_COMPONENT_BOOTSTRAP as s, ɵɵInheritDefinitionFeature as sa, ɵɵviewQuerySignal as sc, getDocument as si, importProvidersFrom as sl, CompilerFactory as sn, ɵɵdomElementContainer as so, SHARED_STYLES_HOST as sr, ɵɵpureFunction1 as ss, provideCheckNoChangesConfig as st, ApplicationModule as t, ɵsetClassDebugInfo as ta, ɵɵtrustConstantResourceUrl as tc, getAsyncClassMetadataFn as ti, createInjector as tl, ApplicationRef as tn, ɵɵdefineDirective as to, ProfilerEvent as tr, ɵɵpipeBind4 as ts, mergeApplicationConfig as tt, Framework as u, ɵɵadvance as ua, ANIMATION_MODULE_TYPE as uc, getLocaleCurrencyCode as ui, isInjectable as ul, ComponentRef as un, ɵɵdomElementEnd as uo, Self as ur, ɵɵpureFunction4 as us, provideStabilityDebugging as ut, Query as v, ɵɵattribute as va, EffectScheduler as vc, isPromise as vi, provideEnvironmentInitializer as vl, DEHYDRATED_BLOCK_REGISTRY as vn, ɵɵelementContainerStart as vo, TemplateRef as vr, ɵɵreadContextLet as vs, withDomHydration as vt, ViewRef as w, ɵɵconditionalCreate as wa, INJECTOR$1 as wc, patchComponentDefWithScope as wi, stringify as wl, Directive as wn, ɵɵforeignContentFn as wo, Type as wr, ɵɵreplaceMetadata as ws, ɵɵngDeclareClassMetadata as wt, RESPONSE_INIT as x, ɵɵcomponentInstance as xa, EventEmitter as xc, markForRefresh as xi, setInjectorProfilerContext as xl, DebugNode as xn, ɵɵenableIncrementalHydrationRuntime as xo, TimerScheduler as xr, ɵɵrepeaterCreate as xs, withIncrementalHydration as xt, REQUEST as y, ɵɵclassMap as ya, EnvironmentInjector as yc, isSubscribable as yi, resolveForwardRef as yl, DebugElement as yn, ɵɵelementEnd as yo, Testability as yr, ɵɵreference as ys, withEventReplay as yt, defaultKeyValueDiffers as z, ɵɵdeferHydrateWhen as za, PLATFORM_INITIALIZER as zc, resetJitOptions as zi, setCurrentInjector as zl, LContext as zn, ɵɵinterpolate2 as zo, bypassSanitizationTrustStyle as zr, ɵɵsyntheticHostListener as zs, chain as zt };
