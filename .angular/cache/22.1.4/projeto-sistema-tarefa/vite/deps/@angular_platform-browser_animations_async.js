...
var AsyncAnimationRendererFactory = class {
	...
	loadImpl() {
		const loadFn = () => {
			...
			return (_this$moduleImpl = this.moduleImpl) !== null && _this$moduleImpl !== void 0 ? _this$moduleImpl : import("./browser-BaJS1U1x.js").then((m) => m);
		};
