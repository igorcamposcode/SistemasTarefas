import { n as _defineProperty$1, t as _objectSpread2 } from "./objectSpread2-C_IE-bIJ.js";
import { $ as isDevMode, $c as assertNotInReactiveContext, Bt as computed, Dc as InjectionToken, Dl as ɵɵdefineInjectable, En as ElementRef, Fn as Injectable, Gc as SecurityContext, Ic as NgZone, In as Input, Mr as afterNextRender, O as booleanAttribute, Oc as Injector, Ol as ɵɵdefineInjector, Qc as assertInInjectionContext, Rc as PLATFORM_ID, Sl as signal, Ui as setClassMetadata, Vc as PendingTasks, Wc as RuntimeError, X as input, ar as RendererFactory2, cl as inject, dr as Service, gc as DestroyRef, hc as DOCUMENT, io as ɵɵdefineService, ir as Renderer2, ml as makeEnvironmentProviders, nl as effect, no as ɵɵdefineNgModule, pc as CSP_NONCE, qn as NgModule, qt as untracked, r as ChangeDetectorRef, rt as numberAttribute, sa as ɵɵInheritDefinitionFeature, to as ɵɵdefineDirective, va as ɵɵattribute, wn as Directive, ya as ɵɵclassMap } from "./core-CXNTKvTk.js";
import { Ct as take, Lt as catchError, O as share, Qn as Subject, Tt as debounceTime, Vn as animationFrameScheduler, Xn as ReplaySubject, Xt as filter, g as takeUntil, jn as of, m as tap, ot as finalize, qn as asapScheduler, rr as Observable, vn as map } from "./esm5-BupzNxh_.js";
import { u as isPlatformBrowser } from "./common-C7YlTbb3.js";
import { c as HttpBackend, l as HttpClient } from "./http-D141V9li.js";
import { r as DomSanitizer } from "./platform-browser-L8fAwU0Z.js";
import { BarsOutline, CalendarOutline, CaretDownFill, CaretDownOutline, CaretUpFill, CaretUpOutline, CheckCircleFill, CheckCircleOutline, CheckOutline, ClockCircleOutline, CloseCircleFill, CloseCircleOutline, CloseOutline, CopyOutline, DeleteOutline, DoubleLeftOutline, DoubleRightOutline, DownOutline, EditOutline, EllipsisOutline, ExclamationCircleFill, ExclamationCircleOutline, EyeInvisibleOutline, EyeOutline, FileFill, FileOutline, FilterFill, InfoCircleFill, InfoCircleOutline, LeftOutline, LoadingOutline, PaperClipOutline, QuestionCircleOutline, RightOutline, RotateLeftOutline, RotateRightOutline, SearchOutline, StarFill, SwapOutline, SwapRightOutline, UpOutline, UploadOutline, VerticalAlignTopOutline, ZoomInOutline, ZoomOutOutline } from "./@ant-design_icons-angular_icons.js";
import { C as warn$1, b as wrapIntoObservable, n as canUseDom, y as updateCSS } from "./ng-zorro-antd-core-util-DcoCxePB.js";
...
//#endregion
//#region node_modules/ng-zorro-antd/fesm2022/ng-zorro-antd-core-color.mjs
/**
...
*/
var hueStep$1 = 2;
var saturationStep$1 = .16;
var saturationStep2$1 = .05;
var brightnessStep1$1 = .05;
var brightnessStep2$1 = .15;
...
function getHue$1(hsv, i, light) {
	let hue;
	if (Math.round(hsv.h) >= 60 && Math.round(hsv.h) <= 240) hue = light ? Math.round(hsv.h) - hueStep$1 * i : Math.round(hsv.h) + hueStep$1 * i;
	else hue = light ? Math.round(hsv.h) + hueStep$1 * i : Math.round(hsv.h) - hueStep$1 * i;
	if (hue < 0) hue += 360;
...
function getSaturation$1(hsv, i, light) {
	...
	let saturation;
	if (light) saturation = hsv.s - saturationStep$1 * i;
	else if (i === darkColorCount$1) saturation = hsv.s + saturationStep$1;
	else saturation = hsv.s + saturationStep2$1 * i;
	if (saturation > 1) saturation = 1;
	if (light && i === lightColorCount$1 && saturation > .1) saturation = .1;
	if (saturation < .06) saturation = .06;
	return Number(saturation.toFixed(2));
}
function getValue$1(hsv, i, light) {
	let value;
	if (light) value = hsv.v + brightnessStep1$1 * i;
	else value = hsv.v - brightnessStep2$1 * i;
	if (value > 1) value = 1;
...
function generate$1(color, opts = {}) {
	...
	if (opts.theme === "dark") return darkColorMap$1.map(({ index, opacity }) => {
		return toHex(mix(inputToRGB(opts.backgroundColor || "#141414"), inputToRGB(patterns[index]), opacity * 100));
	});
	return patterns;
}
//#endregion
//#region node_modules/ng-zorro-antd/fesm2022/ng-zorro-antd-core-config.mjs
var _NzConfigService;
/**
* Use of this source code is governed by an MIT-style license that can be
* found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
*/
...
function getStyle(globalPrefixCls, theme) {
	...
	if (theme.primaryColor) {
		...
		variables["primary-color-deprecated-f-12"] = formatColor(primaryColor, (c) => c.setAlpha(c.getAlpha() * .12));
		const primaryActiveColor = new TinyColor(primaryColors[0]);
		variables["primary-color-active-deprecated-f-30"] = formatColor(primaryActiveColor, (c) => c.setAlpha(c.getAlpha() * .3));
...
function registerTheme(globalPrefixCls, theme, cspNonce) {
	...
	if (canUseDom()) updateCSS(style, `${dynamicStyleMark}-dynamic-theme`, { cspNonce });
	else warn$1(`NzConfigService: SSR do not support dynamic theme with css variables.`);
}
/**
* Use of this source code is governed by an MIT-style license that can be
* found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
...
var NzConfigService = class {
	constructor() {
		_defineProperty$1(this, "configUpdated$", new Subject());
		_defineProperty$1(
			this,
			/**
		...
		_defineProperty$1(
			...
			"config",
			inject(NZ_CONFIG, { optional: true }) || {}
		);
		_defineProperty$1(this, "cspNonce", inject(CSP_NONCE, { optional: true }));
	...
	set(componentName, value) {
		var _this$_configMap$get;
		this.config[componentName] = _objectSpread2(_objectSpread2({}, this.config[componentName]), value);
		(_this$_configMap$get = this._configMap.get(componentName)) === null || _this$_configMap$get === void 0 || _this$_configMap$get.set(this.config[componentName]);
...
_defineProperty$1(NzConfigService, "ɵfac", function NzConfigService_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _NzConfigService)();
});
_defineProperty$1(NzConfigService, "ɵprov", /* @__PURE__ */ ɵɵdefineInjectable({
...
function onConfigChangeEventForComponent(componentName, callback) {
	if (typeof ngDevMode !== "undefined" && ngDevMode) assertInInjectionContext(onConfigChangeEventForComponent);
	...
	return function(_value, context) {
		context.addInitializer(function() {
			...
			Object.defineProperty(this, context.name, {
				get: () => {
					var _nzConfigService$getC;
					const configValue = (_nzConfigService$getC = nzConfigService.getConfigForComponent(this["_nzModuleName"])) === null || _nzConfigService$getC === void 0 ? void 0 : _nzConfigService$getC[context.name];
...
//#endregion
//#region node_modules/@ant-design/icons-angular/fesm2022/ant-design-icons-angular.mjs
var _IconService;
var _IconDirective;
...
function warn(message) {
	if (isDevMode()) console.warn(`${ANT_ICON_ANGULAR_CONSOLE_PREFIX} ${message}.`);
}
...
*/
function parseIconType(type, theme, defaultTheme) {
	if (isIconDefinition(type)) return type;
	else {
		const [name, namespace] = getNameAndNamespace(type);
		if (namespace) return type;
		if (alreadyHasAThemeSuffix(name)) {
			if (theme) warn(`'type' ${name} already gets a theme inside so 'theme' ${theme} would be ignored`);
			return name;
		} else return withSuffix(name, theme || defaultTheme);
	}
}
function NameSpaceIsNotSpecifyError() {
	return /* @__PURE__ */ new Error(`${ANT_ICON_ANGULAR_CONSOLE_PREFIX}Type should have a namespace. Try "namespace:${name}".`);
}
function IconNotFoundError(icon) {
	return /* @__PURE__ */ new Error(`${ANT_ICON_ANGULAR_CONSOLE_PREFIX}the icon ${icon} does not exist or is not registered.`);
}
...
function UrlNotSafeError(url) {
	return /* @__PURE__ */ new Error(`${ANT_ICON_ANGULAR_CONSOLE_PREFIX}The url "${url}" is unsafe.`);
}
function SVGTagNotFoundError() {
	return /* @__PURE__ */ new Error(`${ANT_ICON_ANGULAR_CONSOLE_PREFIX}<svg> tag not found.`);
}
function DynamicLoadingTimeoutError() {
	return /* @__PURE__ */ new Error(`${ANT_ICON_ANGULAR_CONSOLE_PREFIX}Importing timeout error.`);
}
...
var IconService = class {
	...
	get twoToneColor() {
		return _objectSpread2({}, this._twoToneColorPalette);
	}
	/**
	...
	*/
	...
	constructor() {
		_defineProperty$1(this, "sanitizer", inject(DomSanitizer));
		_defineProperty$1(this, "handler", inject(HttpBackend, { optional: true }));
		_defineProperty$1(this, "document", inject(DOCUMENT));
		_defineProperty$1(this, "renderer", inject(RendererFactory2).createRenderer(null, null));
		_defineProperty$1(this, "_http", void 0);
		_defineProperty$1(this, "defaultTheme", "outline");
		_defineProperty$1(
			this,
			/**
		...
		_defineProperty$1(this, "_inProgressFetches", /* @__PURE__ */ new Map());
		_defineProperty$1(
			this,
			/**
		...
		_defineProperty$1(this, "_twoToneColorPalette", {
			primaryColor: "#333333",
		...
		_defineProperty$1(this, "_jsonpIconLoad$", new Subject());
		if (this.handler) this._http = new HttpClient(this.handler);
		const _antIcons = inject(ANT_ICONS, { optional: true });
		if (_antIcons) this.addIcon(..._antIcons);
	}
	/**
	...
	*/
	useJsonpLoading() {
		...
		} else warn("You are already using jsonp loading.");
	}
	/**
	...
	*/
	addIconLiteral(type, literal) {
		...
		if (!namespace) throw NameSpaceIsNotSpecifyError();
		this.addIcon({
			name: type,
			icon: literal
		});
	...
	*/
	getRenderedContent(icon, twoToneColor) {
		...
		if (!definition && this._disableDynamicLoading) throw IconNotFoundError(icon);
		return (definition ? of(definition) : this._loadIconDynamically(icon)).pipe(map((i) => {
			if (!i) throw IconNotFoundError(icon);
	...
	*/
	_loadIconDynamically(type) {
		if (!this._http && !this._enableJsonpLoading) return of(HttpModuleNotImport());
		...
		if (!inProgress) {
			...
			inProgress = (!this._enableJsonpLoading ? this._http.get(safeUrl, { responseType: "text" }).pipe(map((literal) => _objectSpread2(_objectSpread2({}, icon), {}, { icon: literal }))) : this._loadIconDynamicallyWithJsonp(icon, safeUrl)).pipe(tap((definition) => this.addIcon(definition)), finalize(() => this._inProgressFetches.delete(type)), catchError(() => of(null)), share());
	...
	*/
	_loadSVGFromCacheOrCreateNew(icon, twoToneColor) {
		...
		if (cached) svg = cached.icon;
		else {
			svg = this._setSVGAttribute(this._colorizeSVGIcon(this._createSVGElementFromString(hasNamespace(icon.name) ? icon.icon : replaceFillColor(icon.icon)), icon.theme === "twotone", pri, sec));
			this._svgRenderedDefinitions.set(key, _objectSpread2(_objectSpread2({}, icon), {}, { icon: svg }));
		}
		return cloneSVG(svg);
	}
	...
	_colorizeSVGIcon(svg, twotone, pri, sec) {
		if (twotone) {
			...
			for (let i = 0; i < length; i++) {
				...
				if (child.getAttribute("fill") === "secondaryColor") this.renderer.setAttribute(child, "fill", sec);
				else this.renderer.setAttribute(child, "fill", pri);
			}
		}
...
_defineProperty$1(IconService, "ɵfac", function IconService_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _IconService)();
});
_defineProperty$1(IconService, "ɵprov", /* @__PURE__ */ ɵɵdefineService({
	token: _IconService,
	factory: _IconService.ɵfac
}));
(() => {
	(typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(IconService, [{ type: Service }], () => [], null);
})();
	...
	*/
	...
	_clearSVGElement() {
		...
		for (let i = length - 1; i >= 0; i--) {
			var _child$tagName;
			const child = children[i];
			if (((_child$tagName = child.tagName) === null || _child$tagName === void 0 ? void 0 : _child$tagName.toLowerCase()) === "svg") this.renderer.removeChild(this.el, child);
		}
	}
};
var IconDirective = class extends IconBase {
	get selfRenderMeta() {
		return {
			type: this.type(),
			theme: this.theme(),
	...
	constructor() {
		super();
		_defineProperty$1(this, "el", inject(ElementRef).nativeElement);
		_defineProperty$1(this, "renderer", inject(Renderer2));
		_defineProperty$1(this, "iconService", inject(IconService));
		_defineProperty$1(this, "type", input.required(...ngDevMode ? [{ debugName: "type" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "theme", input(...ngDevMode ? [void 0, { debugName: "theme" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "twoToneColor", input(...ngDevMode ? [void 0, { debugName: "twoToneColor" }] : 		/* istanbul ignore next */ []));
		effect(() => {
			this.type();
			this.theme();
			this.twoToneColor();
...
_defineProperty$1(IconDirective, "ɵfac", function IconDirective_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _IconDirective)();
});
_defineProperty$1(IconDirective, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	type: _IconDirective,
	selectors: [[
		"",
		"antIcon",
...
//#endregion
//#region node_modules/ng-zorro-antd/fesm2022/ng-zorro-antd-icon.mjs
var _NzIconService;
var _NzIconPatchService;
var _NzIconDirective;
var _NzIconModule;
/**
* Use of this source code is governed by an MIT-style license that can be
* found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
...
*/
var NzIconService = class extends IconService {
	get _disableDynamicLoading() {
		return !this.platform.isBrowser;
	}
	normalizeSvgElement(svg) {
		if (!svg.getAttribute("viewBox")) this.renderer.setAttribute(svg, "viewBox", "0 0 1024 1024");
		if (!svg.getAttribute("width") || !svg.getAttribute("height")) {
			this.renderer.setAttribute(svg, "width", "1em");
			this.renderer.setAttribute(svg, "height", "1em");
		}
		if (!svg.getAttribute("fill")) this.renderer.setAttribute(svg, "fill", "currentColor");
	}
	...
	constructor() {
		super();
		_defineProperty$1(this, "nzConfigService", inject(NzConfigService));
		_defineProperty$1(this, "platform", inject(Platform));
		_defineProperty$1(this, "configUpdated$", new Subject());
		_defineProperty$1(this, "iconfontCache", /* @__PURE__ */ new Set());
	...
	configDefaultTwotoneColor() {
		const defaultTwotoneColor = this.getConfig().nzTwotoneColor || "#1890ff";
		let primaryColor = DEFAULT_TWOTONE_COLOR;
		if (defaultTwotoneColor) if (defaultTwotoneColor.startsWith("#")) primaryColor = defaultTwotoneColor;
		else warn$1("Twotone color must be a hex color!");
...
_defineProperty$1(NzIconService, "ɵfac", function NzIconService_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _NzIconService)();
});
_defineProperty$1(NzIconService, "ɵprov", /* @__PURE__ */ ɵɵdefineInjectable({
...
var NzIconPatchService = class {
	constructor() {
		_defineProperty$1(this, "extraIcons", inject(NZ_ICONS_PATCH, { self: true }));
		_defineProperty$1(this, "rootIconService", inject(NzIconService));
		_defineProperty$1(this, "patched", false);
	}
	doPatch() {
...
_defineProperty$1(NzIconPatchService, "ɵfac", function NzIconPatchService_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _NzIconPatchService)();
});
_defineProperty$1(NzIconPatchService, "ɵprov", /* @__PURE__ */ ɵɵdefineInjectable({
	token: _NzIconPatchService,
	factory: _NzIconPatchService.ɵfac
}));
(() => {
	(typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NzIconPatchService, [{ type: Injectable }], null, null);
})();
/**
* Use of this source code is governed by an MIT-style license that can be
* found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
*/
var NzIconDirective = class extends IconBase {
	get selfRenderMeta() {
		return {
			type: this.nzType(),
			theme: this.nzTheme(),
	...
	constructor() {
		var _inject;
		super();
		_defineProperty$1(this, "ngZone", inject(NgZone));
		_defineProperty$1(this, "changeDetectorRef", inject(ChangeDetectorRef));
		_defineProperty$1(this, "destroyRef", inject(DestroyRef));
		_defineProperty$1(this, "pendingTasks", inject(PendingTasks));
		_defineProperty$1(this, "isBrowser", isPlatformBrowser(inject(PLATFORM_ID)));
		_defineProperty$1(this, "el", inject(ElementRef).nativeElement);
		_defineProperty$1(this, "renderer", inject(Renderer2));
		_defineProperty$1(this, "iconService", inject(NzIconService));
		_defineProperty$1(this, "nzType", input(...ngDevMode ? [void 0, { debugName: "nzType" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "nzTheme", input(...ngDevMode ? [void 0, { debugName: "nzTheme" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "nzTwotoneColor", input(...ngDevMode ? [void 0, { debugName: "nzTwotoneColor" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "nzSpin", input(false, _objectSpread2(_objectSpread2({}, ngDevMode ? { debugName: "nzSpin" } : 		/* istanbul ignore next */ {}), {}, { transform: booleanAttribute })));
		_defineProperty$1(this, "nzRotate", input(0, _objectSpread2(_objectSpread2({}, ngDevMode ? { debugName: "nzRotate" } : 		/* istanbul ignore next */ {}), {}, { transform: numberAttribute })));
		_defineProperty$1(this, "nzIconfont", input(...ngDevMode ? [void 0, { debugName: "nzIconfont" }] : 		/* istanbul ignore next */ []));
		_defineProperty$1(this, "hostClass", computed(() => {
			const type = this.nzType();
			const spin = this.nzSpin();
			const cls = ["anticon"];
			if (type) cls.push(`anticon-${type}`);
			if (spin || type === "loading") cls.push("anticon-spin");
			return cls;
		}, ...ngDevMode ? [{ debugName: "hostClass" }] : 		/* istanbul ignore next */ []));
		(_inject = inject(NzIconPatchService, { optional: true })) === null || _inject === void 0 || _inject.doPatch();
		...
		effect(() => {
			...
			if (iconfont) this._setSVGElement(this.iconService.createIconfontIcon(`#${iconfont}`));
		});
	}
	/**
	...
	ngAfterContentChecked() {
		if (!this.nzType()) {
			...
			for (let index = children.length - 1; index >= 0; index--) {
				...
				if (child.tagName.toLowerCase() === "svg") this.iconService.normalizeSvgElement(child);
			}
		}
	}
	/**
	...
	*/
	changeIcon2() {
		...
		wrapIntoObservable(this._changeIcon()).pipe(debounceTime(0, this.isBrowser ? animationFrameScheduler : asapScheduler), takeUntilDestroyed(this.destroyRef), finalize(removeTask)).subscribe({
			next: (svg) => {
				this.ngZone.run(() => {
	...
	handleRotate(svg) {
		...
		if (rotate) this.renderer.setAttribute(svg, "style", `transform: rotate(${rotate}deg)`);
		else this.renderer.removeAttribute(svg, "style");
	}
	setSVGData(svg) {
...
_defineProperty$1(NzIconDirective, "ɵfac", function NzIconDirective_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _NzIconDirective)();
});
_defineProperty$1(NzIconDirective, "ɵdir", /* @__PURE__ */ ɵɵdefineDirective({
	...
	hostBindings: function NzIconDirective_HostBindings(rf, ctx) {
		if (rf & 2) {
			ɵɵattribute("aria-label", ctx.nzType());
	...
	inputs: {
		nzType: [1, "nzType"],
		nzTheme: [1, "nzTheme"],
		nzTwotoneColor: [1, "nzTwotoneColor"],
		nzSpin: [1, "nzSpin"],
		nzRotate: [1, "nzRotate"],
		nzIconfont: [1, "nzIconfont"]
	},
	exportAs: ["nzIcon"],
	features: [ɵɵInheritDefinitionFeature]
}));
...
* found in the LICENSE file at https://github.com/NG-ZORRO/ng-zorro-antd/blob/master/LICENSE
*/
var NzIconModule = class NzIconModule {
...
_defineProperty$1(NzIconModule, "ɵfac", function NzIconModule_Factory(__ngFactoryType__) {
	return new (__ngFactoryType__ || _NzIconModule)();
});
_defineProperty$1(NzIconModule, "ɵmod", /* @__PURE__ */ ɵɵdefineNgModule({
	type: _NzIconModule,
	imports: [NzIconDirective],
	exports: [NzIconDirective]
}));
_defineProperty$1(NzIconModule, "ɵinj", /* @__PURE__ */ ɵɵdefineInjector({}));
(() => {
...
//#endregion
export { presetColors as _, NZ_ICON_DEFAULT_TWOTONE_COLOR as a, toObservable as b, NzIconPatchService as c, provideNzIconsPatch as d, NzConfigService as f, isStatusColor as g, isPresetColor as h, NZ_ICONS_USED_BY_ZORRO as i, NzIconService as l, onConfigChangeEventForComponent as m, NZ_ICONS as n, NzIconDirective as o, WithConfig as p, NZ_ICONS_PATCH as r, NzIconModule as s, DEFAULT_TWOTONE_COLOR as t, provideNzIcons as u, statusColors as v, toSignal as x, takeUntilDestroyed as y };
