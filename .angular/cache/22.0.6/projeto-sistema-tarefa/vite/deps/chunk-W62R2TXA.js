...
import {
  ...
  ZoomInOutline,
  ZoomOutOutline
} from "./chunk-S5YOP4XY.js";
import {
  Platform
} from "./chunk-5RX6JVQ6.js";
import {
<<<<<<<< HEAD:.angular/cache/22.0.6/projeto-sistema-tarefa/vite/deps/chunk-PZVYNE7O.js
  _defineProperty,
  canUseDom,
  updateCSS,
  warn,
...
>>>>>>>> cc3bfc73a40949b50ca35f42bf02b7c46b801383:.angular/cache/22.0.6/projeto-sistema-tarefa/vite/deps/chunk-W62R2TXA.js
import {
  DomSanitizer
} from "./chunk-YMTLKOSH.js";
import {
  isPlatformBrowser
...
function parseIconType(type, theme, defaultTheme) {
  if (isIconDefinition(type)) {
    ...
    if (alreadyHasAThemeSuffix(name2)) {
      ...
      return withSuffix(name2, theme || defaultTheme);
    }
  }
}
...
var IconService = class _IconService {
  ...
  constructor() {
    ...
    const _antIcons = inject(ANT_ICONS, {
      optional: true
    });
    if (_antIcons) {
...
var IconDirective = class _IconDirective extends IconBase {
...
var NzIconService = class _NzIconService extends IconService {
  ...
  constructor() {
    super();
    this.addIcon(...NZ_ICONS_USED_BY_ZORRO, ...inject(NZ_ICONS, {
      optional: true
    }) || []);
    this.onConfigChange();
...
var NzIconDirective = class _NzIconDirective extends IconBase {
  ...
  nzTwotoneColor = input(
    ...ngDevMode ? [void 0, {
      debugName: "nzTwotoneColor"
    }] : (
      /* istanbul ignore next */
      []
    )
  );
  nzSpin = input(false, __spreadProps(__spreadValues({}, ngDevMode ? {
    debugName: "nzSpin"
  } : (
    /* istanbul ignore next */
    {}
  ...
  nzRotate = input(0, __spreadProps(__spreadValues({}, ngDevMode ? {
    debugName: "nzRotate"
  } : (
    /* istanbul ignore next */
    {}
...
<<<<<<<< HEAD:.angular/cache/22.0.6/projeto-sistema-tarefa/vite/deps/chunk-PZVYNE7O.js
//# sourceMappingURL=chunk-PZVYNE7O.js.map
========
...
@angular/core/fesm2022/rxjs-interop.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-W62R2TXA.js.map
>>>>>>>> cc3bfc73a40949b50ca35f42bf02b7c46b801383:.angular/cache/22.0.6/projeto-sistema-tarefa/vite/deps/chunk-W62R2TXA.js
